...
import { Styles } from "../../genericGraphs/GraphViz";
...
type EPKVertexType =
	| keyof typeof Gate
	| keyof typeof InformationObject
	| keyof typeof OrganisationUnit
	| keyof typeof ProcessUnit;
...
export class EPKTaskGenerator extends TaskGenerator<EPKGraph, EPKConfig> {
	constructor(
		graphConstructor: Constructor<EPKGraph> = EPKGraph,
		epkGeneratorConstructor: Constructor<EPKGenerator> = EPKGenerator
	) {
